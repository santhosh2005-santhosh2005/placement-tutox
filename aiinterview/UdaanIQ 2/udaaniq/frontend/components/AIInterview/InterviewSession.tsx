...
const InterviewSession: React.FC<InterviewSessionProps> = ({ 
  ...
  const handleRecordingStop = async (blob: Blob) => {
    ...
    try {
      // Validate required parameters before calling uploadAIAnswer
      if (!sessionId || !currentQuestion?.id || !finalText) {
        console.warn('Missing required parameters for uploadAIAnswer:', {
          sessionId,
