    ...
    <div className="py-8 min-h-screen">
      <div className="mb-8">
        ...
        <p className="mt-3 text-lg text-[#5F6368] dark:text-[#9AA0A6] max-w-2xl">
          ...
          Get personalized tutoring with our AI Tutor feature.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        />
        {/* AI Tutor Card - Highlighted with a different color to make it more visible */}
      ...
      <div className="card-elevated mt-8">
        <h2 className="text-2xl font-normal text-center text-[#202124] dark:text-[#E8EAED] mb-6">Getting Started</h2>
        <div className="prose max-w-none">
          <p className="text-[#5F6368] dark:text-[#9AA0A6] mb-4">
            To use all features of this application, make sure all services are running:
          </p>
          <ul className="list-disc pl-5 text-[#5F6368] dark:text-[#9AA0A6] mb-4">
            <li>Main application on <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">http://localhost:3000</code></li>
            <li>AI Tutor service on <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">http://localhost:5500</code></li>
          </ul>
          <p className="text-[#5F6368] dark:text-[#9AA0A6]">
            If you encounter a "fail to fetch" error during signup, please check that the backend service is running on port 3000.
          </p>
        </div>
      </div>
...
// Add AI Tutor Card component
function AITutorCard() {
  return (
    <Link href="http://localhost:5500" target="_blank" className="card hover:shadow-md transition-all duration-200 hover:-translate-y-1 border-2 border-blue-500 bg-blue-50 dark:bg-blue-900/20">
      <div className="flex items-start">
        <div className="p-2 bg-[#4285F4]/10 text-[#4285F4] dark:bg-[#4285F4]/20 dark:text-[#8AB4F8] rounded-lg mr-4">
          <MessageSquareIcon className="h-6 w-6" />
        </div>
        <div>
          <h3 className="text-lg font-medium text-[#202124] dark:text-[#E8EAED] mb-1">AI Tutor</h3>
          <p className="text-sm text-[#5F6368] dark:text-[#9AA0A6]">Get personalized tutoring and learning assistance from our AI tutor.</p>
        </div>
      </div>
    </Link>
  );
